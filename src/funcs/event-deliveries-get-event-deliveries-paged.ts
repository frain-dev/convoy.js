...
export function eventDeliveriesGetEventDeliveriesPaged(
  ...
  Result<
    operations.GetEventDeliveriesPagedResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetEventDeliveriesPagedRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetEventDeliveriesPagedResponse$inboundSchema),
    M.jsonErr(400, errors.GetEventDeliveriesPagedBadRequestError$inboundSchema),
    M.jsonErr(
      401,
