...
* [`GetEventDeliveriesPagedGatewayTimeoutError`](./src/models/errors/get-event-deliveries-paged-gateway-timeout-error.ts): Gateway Timeout. Status code `504`. Applicable to 1 of 68 methods.*
* [`GetEventsPagedGatewayTimeoutError`](./src/models/errors/get-events-paged-gateway-timeout-error.ts): Gateway Timeout. Status code `504`. Applicable to 1 of 68 methods.*
