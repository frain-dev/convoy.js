# DatastorePortalLinkResponseSigningKey
...
```typescript
import { DatastorePortalLinkResponseSigningKey } from "convoy.js/models";

let value: DatastorePortalLinkResponseSigningKey = {};
```
