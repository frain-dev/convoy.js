# DatastorePortalLinkResponseFieldMapping
...
```typescript
import { DatastorePortalLinkResponseFieldMapping } from "convoy.js/models";

let value: DatastorePortalLinkResponseFieldMapping = {};
```
