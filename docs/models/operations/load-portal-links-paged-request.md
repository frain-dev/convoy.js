...
```typescript
import { LoadPortalLinksPagedRequest } from "convoy.js/models/operations";

let value: LoadPortalLinksPagedRequest = {
  projectID: "<id>",
...
| `direction`                                                                                              | [operations.LoadPortalLinksPagedDirection](../../models/operations/load-portal-links-paged-direction.md) | :heavy_minus_sign:                                                                                       | N/A                                                                                                      |                                                                                                          |
